...
public class JwtUtils {
    ...
    public String generateJwtToken(Authentication authentication) {
        ...
        gebruikerDetailsImpl gebruikerPrincipal = (GebruikerDetailsImpl) authentication.getPrincipal();

        return Jwts.builder()
                .setSubject((gebruikerPrincipal.getNaam_gebruiker()))
    ...
    public String getNaam_gebruikerFromJwtToken(String token) {
