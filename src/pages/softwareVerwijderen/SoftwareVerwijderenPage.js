...
function SoftwareVerwijderenPage() {
          ...
          <ol>
            <li className="menu-item">
              ...
              <ol className="sub-menu">
                ...
                <li className="menu-item"><Link to="toevoegen_randapparatuur.html">Randapparatuur</Link></li>
                <li className="menu-item"><Link to="toevoegen_software.html">Software</Link></li>
                <li className="menu-item"><Link to="toevoegen_leverancier.html">Leverancier</Link></li>
                <li className="menu-item"><Link to="toevoegen_storingen.html">Storingen</Link></li>
                <li className="menu-item"><Link to="toevoegen_knowledgebase.html">Knowledgebase</Link></li>
            </ol>
            </li>
            <li className="menu-item">
...
export default SoftwareVerwijderenPage;
